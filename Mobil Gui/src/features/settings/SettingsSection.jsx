    ...
    <div className="space-y-6 text-left" style={{ maxWidth: '900px', margin: '0 auto', paddingBottom: '40px' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(380px, 1fr))', gap: '20px' }}>
        ...
        <div className="glass-card" style={{ padding: '24px', borderRadius: '18px', border: '1px solid rgba(255, 255, 255, 0.05)', background: 'rgba(15, 23, 42, 0.3)', backdropFilter: 'blur(10px)', display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          {/* Theme Settings Grid with Visual Color Previews */}
        ...
        {/* CARD: ALT PANEL NAVİGASYON AYARLARI */}
        <div className="glass-card" style={{ padding: '24px', borderRadius: '18px', border: '1px solid rgba(255, 255, 255, 0.05)', background: 'rgba(15, 23, 42, 0.3)', backdropFilter: 'blur(10px)', display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <h3 style={{ fontSize: '0.95rem', fontWeight: 850, color: 'var(--text-main)', margin: 0, display: 'flex', alignItems: 'center', gap: '8px', borderBottom: '1px solid rgba(255,255,255,0.06)', paddingBottom: '12px' }}>
            <i className="fa-solid fa-square-poll-horizontal" style={{ color: '#818cf8' }}></i> Mobil Alt Panel Ayarları (Tab Seçimi)
          </h3>
          <p style={{ fontSize: '0.74rem', color: 'var(--text-secondary)' }}>
            Mobil ekranda alt panelde (Bottom Navigation Bar) görüntülenecek 4 ana sekmeyi özelleştirin. 5. sekme otomatik olarak "Daha Fazla" menüsü olarak kalacaktır.
          </p>

          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            {[0, 1, 2, 3].map((slotIdx) => {
              const currentVal = mobileTabsConfig[slotIdx] || 'dashboard';
              return (
                <div key={slotIdx} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <span style={{ fontSize: '0.8rem', fontWeight: 'bold', color: 'var(--text-secondary)' }}>Sekme {slotIdx + 1}:</span>
                  <select
                    value={currentVal}
                    onChange={(e) => {
                      const newTabs = [...mobileTabsConfig];
                      newTabs[slotIdx] = e.target.value;
                  ...
                  >
                    <option value="dashboard" style={{ background: '#0d111c' }}>🏠 Ana Sayfa</option>
                    <option value="vocabulary" style={{ background: '#0d111c' }}>📖 Kelime Kampı</option>
                    <option value="camp-vocab" style={{ background: '#0d111c' }}>📅 Gelişmiş Kelime Kampı</option>
                    <option value="camp-custom-vocab" style={{ background: '#0d111c' }}>💾 Özelleştirilmiş Kelime Kampı</option>
                    <option value="camp-grammar" style={{ background: '#0d111c' }}>📚 Gramer Kampı</option>
                    <option value="book-exercises" style={{ background: '#0d111c' }}>📖 YDS Kitap</option>
                    <option value="tests" style={{ background: '#0d111c' }}>📝 Testler</option>
                    <option value="lectures" style={{ background: '#0d111c' }}>🎓 Konu Anlatımı</option>
                    <option value="paragraphs" style={{ background: '#0d111c' }}>📄 Paragraflar</option>
                    <option value="smart-study" style={{ background: '#0d111c' }}>⚡ Akıllı Çalışma</option>
                    <option value="mistakes" style={{ background: '#0d111c' }}>⚠️ Hata Kutusu</option>
                    <option value="performance" style={{ background: '#0d111c' }}>📈 Performans</option>
                    <option value="achievements" style={{ background: '#0d111c' }}>🏆 Başarımlar</option>
                    <option value="pet" style={{ background: '#0d111c' }}>🐾 Evcil Hayvanım</option>
                    <option value="games" style={{ background: '#0d111c' }}>🎮 Mini Oyunlar</option>
                    <option value="settings" style={{ background: '#0d111c' }}>⚙️ Ayarlar</option>
                  </select>
                </div>
              );
            })}
