        ...
        <div className="space-y-3">
          ...
          <div className="glass-card animate-scale-in" style={{ 
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', gap: '6px' }}>
              ...
              <h1 style={{ 
                fontSize: studyWords[currentIdx].word.length > 15 ? '1.6rem' : (studyWords[currentIdx].word.length > 10 ? '2.0rem' : '2.4rem'), 
                fontWeight: '900', 
                color: '#ffffff', 
                margin: 0, 
              ...
              <div style={{ display: 'flex', gap: '6px', flexWrap: 'wrap', justifyContent: 'center', marginTop: '4px' }}>
                <span className="word-badge" style={{ background: 'rgba(255, 255, 255, 0.06)', color: '#cbd5e1', fontSize: '0.65rem', fontWeight: '600', border: '1px solid rgba(255,255,255,0.08)', padding: '3px 10px', borderRadius: '8px' }}>
              ...
              <h2 style={{ 
                fontSize: studyWords[currentIdx].tr.length > 25 ? '1.1rem' : (studyWords[currentIdx].tr.length > 15 ? '1.25rem' : '1.4rem'), 
                fontWeight: '800', 
                color: '#c7d2fe', 
                margin: 0,
                maxWidth: '100%'
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', padding: '12px 16px', borderRadius: '16px', background: 'rgba(251, 191, 36, 0.03)', border: '1px dashed rgba(251, 191, 36, 0.2)' }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '8px' }}>
                <span style={{ fontSize: '0.62rem', color: '#fbbf24', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
              ...
              <div style={{ textAlign: 'left' }}>
                <p style={{ fontSize: '0.82rem', color: '#ffffff', lineHeight: 1.5, margin: '0 0 6px 0', fontWeight: '500' }}>
