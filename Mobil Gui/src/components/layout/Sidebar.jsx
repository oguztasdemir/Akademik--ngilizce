...
const Sidebar = ({ 
  ...
  const mClass = (key) => mobileTabsConfig.includes(key) ? 'mobile-visible' : 'mobile-hidden';
    ...
    <>
      <aside className="app-sidebar-desktop">
        ...
        <nav className="sidebar-nav">
          {/* Main Hub */}
          <button 
            className={`sidebar-nav-item nav-dashboard ${activeTab === 'dashboard' ? 'active' : ''} ${mClass('dashboard')}`}
          ...
          <button 
            className={`sidebar-nav-item nav-vocabulary ${activeTab === 'vocabulary' ? 'active' : ''} ${mClass('vocabulary')}`}
          ...
          {(() => {
            ...
            return (
              <button 
                className={`sidebar-nav-item nav-camp-vocab ${isVocabActive ? 'active' : ''} ${mClass('camp-vocab')}`}
                onClick={() => {
          ...
          {(() => {
            ...
            return (
              <button
                className={`sidebar-nav-item nav-camp-custom-vocab ${isCustomVocabActive ? 'active' : ''} ${mClass('camp-custom-vocab')}`}
                onClick={() => {
          ...
          <button 
            className={`sidebar-nav-item nav-camp-grammar ${activeTab === 'camp-grammar' ? 'active' : ''} ${mClass('camp-grammar')}`}
          ...
          <button 
            className={`sidebar-nav-item nav-book-exercises ${activeTab === 'book-exercises' ? 'active' : ''} ${mClass('book-exercises')}`}
          ...
          <button 
            className={`sidebar-nav-item nav-tests ${activeTab === 'tests' ? 'active' : ''} ${mClass('tests')}`}
          ...
          <button 
            className={`sidebar-nav-item nav-lectures ${activeTab === 'lectures' ? 'active' : ''} ${mClass('lectures')}`}
          ...
          <button 
            className={`sidebar-nav-item nav-paragraphs ${activeTab === 'paragraphs' ? 'active' : ''} ${mClass('paragraphs')}`}
          ...
          <button 
            className={`sidebar-nav-item nav-smart-study ${activeTab === 'smart-study' ? 'active' : ''} ${mClass('smart-study')}`}
          ...
          <button 
            className={`sidebar-nav-item nav-mistakes ${activeTab === 'mistakes' ? 'active' : ''} ${mClass('mistakes')}`}
          ...
          <button 
            className={`sidebar-nav-item nav-performance ${activeTab === 'performance' ? 'active' : ''} ${mClass('performance')}`}
          ...
          <button 
            className={`sidebar-nav-item nav-achievements ${activeTab === 'achievements' ? 'active' : ''} ${mClass('achievements')}`}
          ...
          <button 
            className={`sidebar-nav-item nav-pet ${activeTab === 'pet' ? 'active' : ''} ${mClass('pet')}`}
          ...
          <button 
            className={`sidebar-nav-item nav-games ${activeTab === 'games' ? 'active' : ''} ${mClass('games')}`}
          ...
          <button 
            className={`sidebar-nav-item nav-settings ${activeTab === 'settings' ? 'active' : ''} ${mClass('settings')}`}
